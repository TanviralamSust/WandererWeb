                     ...
                     <div class="header-content">
                        <div class="header-bottom">
                           ...
                           <ul class="header-nav-primary nav nav-pills collapse navbar-collapse">
                              ...
                              <li >
                                 <a href="{{route('agent.create')}}">tripMake </a>
                              </li>
                              </li>
                              @if(auth()->check())    
                              <li>
                           ...
                           <div class="row">
                                 ...
                                 <div class="row">
                                    <div class="col-sm-6">
                                       <div class="card" data-background-image="assets/img/tmp/product-4.jpg">
                                          <div class="card-label">
                                             <a href="/userblogdetails">Restaurant</a>
                                          </div>
                                          <!-- /.card-label -->
                                          <div class="card-content">
                                    ...
                                    <div class="col-sm-6">
                                       <div class="card" data-background-image="assets/img/tmp/product-2.jpg">
                                          <div class="card-label">
                                             <a href="/userblogdetailsl">Vacation</a>
                                          </div>
                                          <!-- /.card-label -->
                                          <div class="card-content">
                                             ...
                                             <div class="card-actions">
                                                ...
                                                <a href="/userblogdetails" class="fa fa-search"></a>
                                                <a href="#" class="fa fa-heart-o"></a>
                                             </div>
                                          </div>
                                          <!-- /.card-content -->
                              ...
                              <div class="col-sm-4">
                                 <div class="card card-tall" data-background-image="assets/img/tmp/product-1.jpg">
                                    <div class="card-label">
                                       <a href="/userblogdetails">Vacation</a>
                                    </div>
                                    <!-- /.card-label -->
                                    <div class="card-content">
