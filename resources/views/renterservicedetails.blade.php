            ...
            <div class="container">
                <div class="header-inner">
                    ...
                    <ul class="header-nav-primary nav nav-pills collapse navbar-collapse">
                        <li >
                            <a href="renter-index">Home <i class="fa fa-chevron-down"></i></a>
                        </li>
...
<div class="posts post-detail">
    ...
    <div class="Wrapper">
        <img src="{{asset('renter/'.$data->photo1)}}" alt="Smiley face" height="250" width="250" />
        <img src="{{asset('renter/'.$data->photo2)}}" alt="Smiley face" height="250" width="250" />
        <img src="{{asset('renter/'.$data->photo3)}}" alt="Smiley face" height="250" width="250" />
        <img src="{{asset('renter/'.$data->photo4)}}" alt="Smiley face" height="250" width="250" />
    </div>
    ...
    <h2>Cost:  {{$data->description}}</h2>
    <h2>Service Availabiltiy:  12-01-18 to 14-01-18</h2>


    <h2>For Booking:</h2>
    <h3>Agent Name: {{$data->userRenter->name}}</h3>
    <h3>contact Num: {{$data->userRenter->contact}}</h3>
